...
let x = parseFromFile("Ex1.gc");;

// You must revise this path
System.IO.Directory.SetCurrentDirectory @"C:\users\stefan\git\02257-anvendt-funktionsprogrammering\Project 2\GuardedCommands";;
...
List.iter exec ["A4.gc"; "Swap.gc"; "factImpPTyp.gc";"QuickSortV1.gc"];;
...
//Our own programs
List.iter exec ["Pointer.gc"; "InsertionSort.gc"];;